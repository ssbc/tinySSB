...
function menu_start_game_of_blackjack() {
    console.log('a')
    closeOverlay();
    document.getElementById('lst:games').style.display = 'none';
    document.getElementById('blackjack-start-game').style.display = 'initial';
    document.getElementById('lst:blackjack').style.display = 'initial';
    document.getElementById('initial-display').style.display = 'initial';
    document.getElementById('current-game-screen').style.display = 'initial';
}
...
function initializePlayerGame(dealerCards, playerCards, dealerMessage) {
    ...
    */
    ...
    const cardImg = document.createElement('img');
    cardImg.src = `bj_cards/${dealerCards[1]}.svg`;
    ...
    cardImgBackside.src = `bj_cards/1B.svg`;
    ...
    */
    ...
    avatarImg.src = 'dealer-avatar.png'; // Adjust path as necessary
